...
import { DEMOS as ClipboardDemo } from '@/app/docs/components/[slug]/components/clipboard/static'
import { DEMOS as CollapsibleDemo } from '@/app/docs/components/[slug]/components/collapsible/static'
...
<CodePreview {...ClipboardDemo.basic} />
<br />
...
<CodePreview {...ClipboardDemo.button} />
...
<CodePreview {...CollapsibleDemo.basic} />
...
<CodePreview {...CollapsibleDemo.fade} />
